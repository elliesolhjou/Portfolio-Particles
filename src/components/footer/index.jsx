      ...
      <footer className="flex flex-col text-black px-4 py-2 items-center justify-center rounded dark:bg-none dark:text-white font-mono">
        <div className="md:flex p-2 md:justify-evenly">
          <div className=" flex flex-row place-items-center gap-4 md:gap-8">
            <a
              href="https://www.linkedin.com/in/elliesolhjou/"
              target="_blank"
              rel="noreferrer"
            >
              <span className="hover:text-blue-500 dark:hover:text-red-500">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  strokeWidth="0"
            ...
            <a
              href="https://github.com/elliesolhjou"
              target="_blank"
              rel="noreferrer"
            >
              <span className="hover:text-blue-500 dark:hover:text-red-500">
        ...
        <p>Copyright Reserved by Ellie Solhjou 2023</p>
